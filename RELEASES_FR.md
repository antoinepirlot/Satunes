...
* Tous les types de media (musiques, artistes, etc.) ont un navBarSection d'option lors d'un appuis
  long
...
* Navigation vers les albums, genres, artistes, etc. depuis le navBarSection d'un appui long sur une
  musique
...
* Ajout d'un navBarSection dans les paramètres expliquant comment activer Android Auto
