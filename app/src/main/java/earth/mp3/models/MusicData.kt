...
fun loadMusics(
    context: Context,
    musicDataList: MutableList<MusicData>,
    ...
    context.contentResolver.query(
        ...
        while (cursor.moveToNext()) {
            ...
            val musicData = MusicData(id, name, duration, size, fileUri, relativePath)
            ...
            rootFolder!!.getSubFolder(splitedPath.toMutableList())!!.addMusic(musicData)
        }
    }
}
