...
class OldPlaybackController private constructor(
    context: Context,
    ...
    companion object {
        ...
        private lateinit var instance: OldPlaybackController
         ...
         */
        fun getInstance(): OldPlaybackController {
        ...
        fun initInstance(
            context: Context,
            musicMap: SortedMap<Long, Music>
        ): OldPlaybackController {
            if (!Companion::instance.isInitialized) {
                val sessionToken =
                    SessionToken(context, ComponentName(context, PlaybackService::class.java))
                instance = OldPlaybackController(
                    context = context,
                    sessionToken = sessionToken,
                    musicMap = musicMap,
                )
