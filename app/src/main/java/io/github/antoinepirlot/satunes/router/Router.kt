...
//    HandleBackButtonPressed()
    ...
    val currentBackStackEntry by LocalNavController.current.currentBackStackEntryAsState()
    ...
    LaunchedEffect(key1 = currentRoute) {
        val currentDestination: Destination = Destination.getDestination(destination = currentRoute)
        navigationViewModel.setCurrentDestination(destination = currentDestination.link)
    }
