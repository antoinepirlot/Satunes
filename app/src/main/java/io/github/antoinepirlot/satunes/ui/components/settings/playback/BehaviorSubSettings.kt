...
/**
 * @author Antoine Pirlot 12/02/2025
 */
@Composable
internal fun BehaviorSubSettings(
    ...
    SubSettings(
        ...
        SettingsSwitchList(checkedMap = playbackSettingsChecked)
        BarSpeedSetting()
    }
}
...
@Preview
@Composable
private fun BehaviorSubSettingsPreview(modifier: Modifier = Modifier) {
    BehaviorSubSettings()
}